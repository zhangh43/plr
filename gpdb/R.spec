...
echo "export LD_LIBRARY_PATH=\$LD_LIBRARY_PATH:/lib64:\$GPHOME/ext/R-%{r_ver}/lib64/R/lib:\$GPHOME/ext/R-%{r_ver}/extlib" >> $GPHOME/greenplum_path.sh
...
sed -i".bk" "s|export LD_LIBRARY_PATH=\$LD_LIBRARY_PATH:/lib64:\$GPHOME/ext/R-%{r_ver}/lib64/R/lib:\$GPHOME/ext/R-%{r_ver}/extlib||g" $GPHOME/greenplum_path.sh
