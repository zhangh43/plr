...
%post
sed -i "s|export R_HOME=\$GPHOME/ext/R-3.3.1||g" $GPHOME/greenplum_path.sh
sed -i "s|export LD_LIBRARY_PATH=\$GPHOME/ext/R-3.3.1/lib:\$GPHOME/ext/R-3.3.1/extlib:\$LD_LIBRARY_PATH||g" $GPHOME/greenplum_path.sh
sed -i "s|export PATH=\$GPHOME/ext/R-3.3.1/bin:\$PATH||g" $GPHOME/greenplum_path.sh
